...
public class Main {
    ...
    public static boolean testForIncrementTask1(String string) {
        if (string.charAt(0) > string.charAt(1) || string.charAt(1) > string.charAt(2) || string.charAt(2) > string.charAt(3) ||
                string.charAt(3) > string.charAt(4) || string.charAt(4) > string.charAt(5)) {
            return false;
        } else {
            return true;
        }
    ...
    public static boolean testForIncrementOrSameTask2(String string) {
        if (testForIncrementTask1(string) && testForDoubles(string)) {
            ...
            if (string.charAt(4) == string.charAt(5) && string.charAt(4) != string.charAt(3)) {
                return true;
            } else {
                return false;
            }
